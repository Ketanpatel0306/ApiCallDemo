...
const Ind = () => {
  ...
  const fatchData = () => {
    let ar = [];
    Object.keys(Data).map((curElm) => {
      Object.keys(Data[curElm].districts).map((dis) => {
      ...
      <div>
        <center>
          ...
          <table>
            ...
            <tr>
              <th colspan="5">
                <button onClick={Click} style={{ margin: "15px 0px" }}>Submit</button>
              </th>
            </tr>
            <thead>
              <tr>
                ...
                <th>
                  vaccinated1
                  <button onClick={asendvac} style={{ marginLeft: "10px", marginRight: "3px" }}> &#8744;</button>
                  <button onClick={disendvac}>  &#x2227;</button>
                </th>
                <th>
                  Recoverd
                  <button onClick={asendrec} style={{ marginLeft: "10px", marginRight: "3px" }}> &#8744;</button>
                  <button onClick={disendrec}>  &#x2227;</button>
                </th>
                <th>
                  Confirmed
                  <button onClick={asendcon} style={{ marginLeft: "10px", marginRight: "3px" }}> &#8744;</button>
            ...
            {newMain.map((val) => {
              return (
                <tr>
                  <td style={{ marginBottom: "15px" }}>{val.state}</td>
                  <td style={{ marginBottom: "15px" }}>{val.city}</td>
                  <td style={{ marginBottom: "15px" }}>{val.vaccinated}</td>
                  <td style={{ marginBottom: "15px" }}>{val.recoverd}</td>
                  <td style={{ marginBottom: "15px" }}>{val.confirmed}</td>
                </tr>
              );
            })}
          </table>
